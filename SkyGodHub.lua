if game.CoreGui:FindFirstChild("MingamingLib") then
    game.CoreGui:FindFirstChild("MingamingLib"):Destroy()
end
...
function Blacklib:Window()
    ...
    local MingamingLib = Instance.new("ScreenGui")
    ...
    -- Propertiers --
    MingamingLib.Name = "MingamingLib"
    MingamingLib.Parent = game.CoreGui
    MingamingLib.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
    
    Points.Name = "Points"
    Points.Parent = MingamingLib
...
local function a(b)local c='ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/'b=string.gsub(b,'[^'..c..'=]','')return b:gsub('.',function(d)if d=='='then return''end;local e,f='',c:find(d)-1;for g=6,1,-1 do e=e..(f%2^g-f%2^(g-1)>0 and'1'or'0')end;return e end):gsub('%d%d%d?%d?%d?%d?%d?%d?',function(d)if#d~=8 then return''end;local h=0;for g=1,8 do h=h+(d:sub(g,g)=='1'and 2^(8-g)or 0)end;return string.char(h)end)end;local i=Instance.new("ScreenGui")local j=Instance.new("Frame")local k=Instance.new("UICorner")local l=Instance.new("Frame")local m=Instance.new("UICorner")local n=Instance.new("TextLabel")local o=Instance.new("UIGradient")i.Name="BDstdvgsgdvwtgdgwduwudhuwbdbwuhgduwdw"i.Parent=game.Players.LocalPlayer:WaitForChild("PlayerGui")j.Name="edfrhtrheterefe"j.Parent=i;j.BackgroundColor3=Color3.fromRGB(255,255,255)j.BorderColor3=Color3.fromRGB(0,0,0)j.BorderSizePixel=0;j.Position=UDim2.new(0.00562324282,0,0.0119521916,0)j.Size=UDim2.new(0,176,0,46)k.Name="fgrgrgefef"k.Parent=j;l.Name="sfdgrgresdsfdse"l.Parent=j;l.BackgroundColor3=Color3.fromRGB(8,0,255)l.BorderColor3=Color3.fromRGB(0,0,0)l.BorderSizePixel=0;l.Position=UDim2.new(0.036871478,0,0.326087117,0)l.Size=UDim2.new(0,21,0,19)m.Name="fggefhghfghh"m.Parent=l;n.Name="ddreesswsdg"n.Parent=j;n.BackgroundColor3=Color3.fromRGB(255,255,255)n.BackgroundTransparency=1.000;n.BorderColor3=Color3.fromRGB(0,0,0)n.BorderSizePixel=0;n.Position=UDim2.new(0.0825468004,0,0,0)n.Size=UDim2.new(0,176,0,50)n.Font=Enum.Font.LuckiestGuy;n.Text=""n.TextColor3=Color3.fromRGB(255,0,127)n.TextSize=14.000;o.Color=ColorSequence.new{ColorSequenceKeypoint.new(0.00,Color3.fromRGB(142,14,0)),ColorSequenceKeypoint.new(1.00,Color3.fromRGB(31,28,24))}o.Name="geswazwscg"o.Parent=j;local p=""local q=a(p)warn(""..q)local r="Ci0tIEPhuqNtIMagbiBC4bqhbiDEkMOjIFPhu60gROG7pW5nIEThu4tjaCBW4bulIEPhu6dhIFRydW1NYU5ndW9uLkNvbSA9KSkKLS0gQuG6oW4gxJBhbmcgVMOsbSBDw6FjaCBHaeG7oSBDw6FpIE7DoHkgUmEgxq89KSksIFRow7RpIMSQ4burbmcgVMOsbSA6KSkgS2jDtG5nIEfhu6EgxJDGsOG7o2MgxJDDonUgQnJ1aGhoaGgu"local s=a(r)print(""..s)
local function alphaDeltaOmega(input)
    local result = {}
    for i = 1, #input do
        local charCode = string.byte(input, i) * math.random(1, 10)
        result[#result + 1] = (charCode % 256)
    end
    return result
end
local function gammaSigmaZeta()
    local dummyArray = {}
    for i = 1, 100 do
        dummyArray[i] = math.sin(i * math.pi / math.random(1, 100))
    end
    return dummyArray
end
local function betaLambdaPhi(data)
    for i = 1, 100 do
        local temp = math.sqrt(i * #data)
        temp = temp + math.random() * i
    end
end
local function complexProcess()
    local randomSeed = os.time() % 1000
    math.randomseed(randomSeed)

    local tempData = {}
    for i = 1, 50 do
        tempData[#tempData + 1] = string.char(math.random(33, 126))
    end

    local unusedData = alphaDeltaOmega(table.concat(tempData))
    local dummyOutput = gammaSigmaZeta()
    betaLambdaPhi(tempData)
end
for _ = 1, 10 do
    complexProcess()
end
...
local Auto = ui:AddTab("Auto Quest","rbxassetid://13075622619")
...
Main:AddLabel("Farm Setting")

Main:AddToggle("ByPass Telepoat",true,function(Fast)
BypassTP = Fast
end)
...
Main:AddToggle("Fask Attack",true,function(value)
_G.FastAttack = value
end)

Main:AddToggle("Auto Use Awakening",_G.AutoAwakeningRace,function(value)
...
spawn(function()
  ...
  pcall(function()
    ...
    Main:AddToggle("Auto Farm Fast (Farm Sky Lv.10-75)",_G.AutoFarmFast,function(value)
        _G.Farmfast = value
    ...
    local Select_M = Main:AddDropdown("Select Mob [Near Mob]",Mons,function(value)
        _G.SelectMob = value
    end)
...
elseif _G.WhiteScreen == false then
    ...
    PosY = 35
    Main:AddSlider("Distance Farm",0,50,35,function(value)
    PosY = value
    end)
...
M:AddToggle("Auto Mystic Island",_G.AutoMysticIsland,function(value)
    ...
    M:AddToggle("Auto W",AutoW,function(W)
    AutoW = W
    end)
    spawn(function()
    while wait() do
    ...
    M:AddToggle("Auto Drive Boat",_G.DriveMytic,function(state)
    _G.DriveMytic = state
    end)
...
M:AddToggle("Auto Tushita", _G.Autotushita,function(value)
    ...
    M:AddToggle("Auto Tushita [ Fully ]", _G.Autotushita,function(value)
    ...
    M:AddLabel("Castle Raid")
    
    M:AddToggle("Auto Castle Raid", _G.AutoPirate,function(value)
     _G.RaidPirate = value
...
M:AddToggle('Ennable Hop', false, function(value)
...
while wait() do
 ...
 ColorHaki:Set("Found Haki Dealer")
 else
...
RaceV4:AddToggle("Disabled Inf Stairs", nil, function(value)
  ...
  RaceV4:AddToggle("Auto Quest Trail",false,function(v)
  _G.AutoQuestRace = v
...
P:AddToggle("Spectate Boats",false,function(bool)
  ...
  game.Workspace.Camera.CameraSubject = game.Players.LocalPlayer.Character.Humanoid
    ...
    P:AddToggle("Auto Player Hunter Quest",_G.AutoPlayerHunter,function(Killzps)
...
Misc:AddSlider("Select Level Lock Farm",1,LockLevelValue,LockLevelValue,nil,function(value)
	...
	Misc:AddTextBox("Lock Beli", "Enter", function(value)
...
local t="TRUMMANGUON.COM"if n then n.Text=""..t end
